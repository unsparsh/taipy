...
class Config:
    ...
    def configure_s3_object_data_node(
        ...
        aws_s3_client_arguments: Optional[Dict[str, Any]] = None,
        aws_s3_get_object_arguments: Optional[Dict[str, Any]] = None,
        aws_s3_put_object_arguments: Optional[Dict[str, Any]] = None,
        scope: Optional[Scope] = None,
        validity_period: Optional[timedelta] = None,
        **properties,
    ) -> "DataNodeConfig":
